  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        `/api/build-requests/${buildRequestHash}/claims`,
        {
          method: "POST",
          headers: {
                ...
                {step === "form" ? (
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-300">
                          Share your project details below. After submission,
                          you'll have the option to share it on Warpcast.
                        </p>
                      </div>
                    </div>
                  ...
                  <>
                    <div className="mt-3 text-center sm:mt-0 sm:text-left">
                      ...
                      <div className="mt-2">
                        <p className="text-sm text-gray-300">
                          Your build has been recorded. Would you like to share
                          it on Warpcast?
                        </p>
                      </div>
                    </div>
