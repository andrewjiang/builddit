...
export function BuildRequestsContent({ initialBuildRequests }: BuildRequestsContentProps) {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-purple-900 via-purple-800 to-purple-700 relative">
            ...
            {/* Post Build Modal */}
            <PostBuildModal isOpen={isPostModalOpen} onClose={() => setIsPostModalOpen(false)} />
