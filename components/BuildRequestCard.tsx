...
function EmbeddedCastCard({ cast, depth = 0 }: { cast: EmbeddedCast; depth?: number }) {
    ...
    return (
        <div className={`mt-2 p-4 rounded-lg bg-purple-700/30 border border-purple-600/30 
    ...
    return (
        ...
        >
            ...
            <div className="flex items-center justify-between mt-4" data-oid="s3j_83f">
                <div className="flex items-center space-x-3 text-sm text-purple-300" data-oid="h-_0k9j">
                    <time dateTime={dateTimeString} className="text-purple-400" data-oid="ezyg68b">
                        {formattedDate}
                    </time>
                    <span className="hidden md:inline text-purple-600" data-oid="qmdtok:">•</span>
                    <div className="flex items-center space-x-3" data-oid="0q200ip">
                        ...
                        >
                            ...
                            <span className="group-hover/like:text-pink-400 transition-colors" data-oid="n6lax8-">
                                {likes}
                            </span>
                        </button>
                        <span className="hidden md:inline text-purple-600" data-oid="qmdtok:">•</span>
                        <button
                            onClick={(e) => { e.stopPropagation(); handleReaction('recast'); }}
                ...
                <button
                    onClick={(e) => { e.stopPropagation(); handleBuildClick(); }}
