            ...
            <div className="flex flex-col space-y-4">
                ...
                <div className="flex flex-col md:flex-row justify-between items-stretch md:items-center space-y-4 md:space-y-0">
                    ...
                    <div className="flex items-center space-x-4">
                        <span className="text-purple-100 font-medium text-sm md:text-base">Sort by:</span>
                                ...
                                {({ open, close }) => (
                                    <>
                                        ...
                                        >
                                            <span>Top</span>
                                            {currentSort.startsWith('top_') && (
                                                <span className="opacity-90 hidden md:inline">: {timeWindows.find(tw => currentSort === `top_${tw.id}`)?.label}</span>
                                            )}
                                            <ChevronDownIcon
                    ...
                    <div className="flex flex-col space-y-4 md:space-y-0 md:flex-row md:items-center md:space-x-4 md:justify-end">
                        {/* Search Bar */}
                        <form onSubmit={handleSubmit} className="w-full md:w-64 order-1 md:order-2">
