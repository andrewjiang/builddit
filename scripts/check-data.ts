...
async function checkData() {
    try {
        ...
        latestBuildRequests.forEach(req => {
            ...
            console.log(`  Engagement: ${req.engagement.likes} likes, ${req.engagement.recasts} recasts\n`);
        });
        ...
        topScores.forEach(score => {
            ...
            console.log(`  Metrics: ${score.metrics.likes} likes, ${score.metrics.recasts} recasts, ${score.metrics.replies} replies\n`);
        });
