...
async function clearModels() {
  try {
    ...
    const BuildRequest =
      ...
      mongoose.model("BuildRequest", new mongoose.Schema({}));
    const BuildClaim =
      mongoose.models.BuildClaim ||
      mongoose.model("BuildClaim", new mongoose.Schema({}));
    const FarcasterUser =
      mongoose.models.FarcasterUser ||
      mongoose.model("FarcasterUser", new mongoose.Schema({}));
