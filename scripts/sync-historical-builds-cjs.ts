...
const ReactionsSchema = z.object({
    ...
    likes: z.array(z.object({ fid: z.number(), fname: z.string().optional() })),
    recasts: z.array(z.object({ fid: z.number(), fname: z.string().optional() })),
});
...
const EmbeddedCastSchema = z.lazy(() => z.object({
    ...
    embeds: z.array(z.object({
        ...
        cast: z.lazy(() => EmbeddedCastSchema.optional()),
        metadata: z.object({
            html: z.object({
    ...
    embeds: [{
        ...
        cast: {
            ...
            embeds: [{
                ...
                cast: { type: mongoose.Schema.Types.Mixed },
            }],
        },
        metadata: {
            html: {
...
class NeynarClient {
    ...
    async fetchBuildRequests(cursor?: string, limit: number = 100) {
